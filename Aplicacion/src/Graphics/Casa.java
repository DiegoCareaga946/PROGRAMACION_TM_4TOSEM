...
public class Casa extends JFrame {
    ...
    public void paint(Graphics g) {
        ...
        g2.setColor(new Color(255, 217, 236));      
        g2.fillOval(-400, -400, 2500, 2500);
        
        g2.setColor(new Color(255, 201, 228));      
        g2.fillOval(-80, -80, 2500, 2500);
        
        g2.setColor(new Color(255, 163, 209));
        ...
        g2.setColor(new Color(160, 219, 121)); // Hojas Arbol
        ...
        g2.setColor(new Color(129, 204, 70));
