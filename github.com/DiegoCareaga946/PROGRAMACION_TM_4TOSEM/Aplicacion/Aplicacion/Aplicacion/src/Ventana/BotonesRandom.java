...
public class BotonesRandom extends JFrame{
public BotonesRandom (String title) {
		...
		click.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				nuevo.setBackground(new Color(random.nextFloat(), random.nextFloat(), random.nextFloat()));
				fondo.add(nuevo);
				fondo.repaint();
			}
		});
	...
	public static void main(String[] args) {
		BotonesRandom prueba = new BotonesRandom("");
